...
public class TestBossBar : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        CurrentChanges = Boss.GetComponent<TestBossAI>().CurrentHealth;
    }

    void FixedUpdate()
    {
        float current = Boss.GetComponent<TestBossAI>().CurrentHealth;
        float max = Boss.GetComponent<TestBossAI>().MaxHealth;
